# 🌍 UAO Worldwide Multi-Region, Cross-OS & Multi-Cloud Master Architecture
...
| :--- | :--- | :---: | :---: | :--- |
| **Speech STT** | `whisper.cpp` (OpenAI Whisper) | **Port 8094** | **< 45 ms** | `...\AI_Dedicated_Storage_MultiModaludio_stt_tts\` |
| **Voice TTS** | `Piper TTS Engine` | **Port 8095** | **< 60 ms** | `...\AI_Dedicated_Storage_MultiModaludio_stt_tts\` |
| **Vision OCR** | `LLaVA-v1.6` / `Qwen2-VL` | **Port 8096** | **< 300 ms** | `...\AI_Dedicated_Storage_MultiModalisual_ocr\` |
| **Image Creation** | `FLUX.1-schnell` / `SDXL Turbo` | **Port 8097** | **< 1.5 s** | `...\AI_Dedicated_Storage_MultiModalisual_image_gen\` |
| **Audio & SFX** | `Meta MusicGen` + `AudioGen` | **Port 8098** | **< 1.0 s** | `...\AI_Dedicated_Storage_MultiModaludio_sound_gen\` |
| **Video Motion** | `Stable Video Diffusion (SVD)` | **Port 8099** | **< 4.0 s** | `...\AI_Dedicated_Storage_MultiModalisual_video_gen\` |
