#!/usr/bin/env python3
"""
Master Dependencies & Retrieval Sources Catalog Generator
Generates a comprehensive inventory catalog detailing all GGUF model weights, multi-modal engines,
Anaconda AI platform frameworks, and their exact retrieval source URLs.
"""

import os
import platform

def generate_dependencies_catalog():
    markdown_content = """# 📚 UAO Master Dependencies & Retrieval Source Links Inventory
...
| :--- | :--- | :--- | :--- | :--- |
| **Speech STT (Port 8094)** | `whisper.cpp` (`medium.en`) | `ggerganov/whisper.cpp` | [Whisper.cpp Repository](https://github.com/ggerganov/whisper.cpp) | `...\AI_Dedicated_Storage_MultiModal\audio_stt_tts\` |
| **Voice TTS (Port 8095)** | `Piper TTS Engine` | `rhasspy/piper` | [Piper TTS Repository](https://github.com/rhasspy/piper) | `...\AI_Dedicated_Storage_MultiModal\audio_stt_tts\` |
| **Vision OCR (Port 8096)** | `LLaVA-v1.6-7B` / `Qwen2-VL` | `haotian-liu/LLaVA` | [LLaVA Vision Repository](https://github.com/haotian-liu/LLaVA) | `...\AI_Dedicated_Storage_MultiModal\visual_ocr\` |
| **Image Gen (Port 8097)** | `FLUX.1-schnell` / `SDXL` | `black-forest-labs/FLUX.1-schnell` | [FLUX.1 Model Link](https://huggingface.co/black-forest-labs/FLUX.1-schnell) | `...\AI_Dedicated_Storage_MultiModal\visual_image_gen\` |
| **Audio & SFX (Port 8098)** | `Meta MusicGen` + `AudioGen` | `facebook/musicgen-small` | [MusicGen Model Link](https://huggingface.co/facebook/musicgen-small) | `...\AI_Dedicated_Storage_MultiModal\audio_sound_gen\` |
| **Video Motion (Port 8099)**| `Stable Video Diffusion (SVD)`| `stabilityai/stable-video-diffusion` | [SVD Model Link](https://huggingface.co/stabilityai/stable-video-diffusion-img2vid-xt) | `...\AI_Dedicated_Storage_MultiModal\visual_video_gen\` |
...
"""
    ...
    output_path = r"C:\Users\Monica Fugazi\.antigravity-ide\living_repository\templates\master_dependencies_and_retrieval_sources.md"
    if platform.system() != "Windows":
        output_path = "/mnt/c/Users/Monica Fugazi/.antigravity-ide/living_repository/templates/master_dependencies_and_retrieval_sources.md"

    with open(output_path, "w", encoding="utf-8") as f:
        f.write(markdown_content)
    print(f"[+] Generated Master Dependencies & Retrieval Sources Catalog: {output_path}")

if __name__ == "__main__":
    generate_dependencies_catalog()
